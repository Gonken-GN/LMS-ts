...
exports.createLayout = (0, catchAsyncError_1.CatchAsyncError)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { type } = req.body;
        const ifExists = yield layout_model_1.default.findOne({ type });
        if (ifExists) {
            return next(new ErrorHandler_1.default(`Layout with ${type} already exists`, 400));
        }
        if (type === "Banner") {
...
exports.editLayout = (0, catchAsyncError_1.CatchAsyncError)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (type === "Banner") {
            ...
            yield layout_model_1.default.findByIdAndUpdate(bannerData, { banner });
        }
        if (type === "FAQ") {
            const { faq } = req.body;
            const FAQ = yield layout_model_1.default.findOne({ type: "FAQ" });
            const faqItems = yield Promise.all(faq.map((item) => __awaiter(void 0, void 0, void 0, function* () {
                return {
                    question: item.question,
                    answer: item.answer,
            ...
            yield layout_model_1.default.findByIdAndUpdate(FAQ === null || FAQ === void 0 ? void 0 : FAQ._id, {
                type: "FAQ",
                faq: faqItems,
            });
        }
        if (type === "Categories") {
            const { categories } = req.body;
            const categoriesModel = yield layout_model_1.default.findOne({
                type: "Categories",
            });
            const categoriesItems = yield Promise.all(categories.map((item) => __awaiter(void 0, void 0, void 0, function* () {
                return {
            ...
            yield layout_model_1.default.findOneAndUpdate(categoriesModel === null || categoriesModel === void 0 ? void 0 : categoriesModel._id, {
                type: "Categories",
                categories: categoriesItems,
            });
        }
